      ...
      <nav className="fixed top-0 w-full z-50 bg-black/80 backdrop-blur-xl border-b border-neutral-800/50">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link href="/product-research" className="text-sm px-4 py-2 rounded-full bg-neutral-800 hover:bg-neutral-700 text-white border-neutral-700">Product</Link>
          ...
          <AnimatePresence mode="wait">
            {!loading ? (
              <motion.div key="form" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }}>
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-neutral-500">Real-time keyword data, SERP analysis, and content strategy.</p>
                  </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <button
                    type="submit"
                    className="w-full flex items-center justify-center gap-2 px-6 py-4 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-semibold transition-all text-lg"
                  >
                    Generate SEO Report
              ...
              <motion.div key="loading" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 1.05 }} className="glass rounded-3xl p-12 text-center space-y-8">
                ...
                <div>
                  <h2 className="text-xl font-semibold mb-2">Generating SEO Intelligence</h2>
                  <p className="text-neutral-500 text-sm">Analyzing keywords, SERP, and trends...</p>
                </div>
